...
abstract class ArtxContentItem extends ArtxContentArticleBase
{
    ...
    public function emailIcon()
    {
        ...
        $text = str_replace('<i class="icon-envelope', '<i class="dd-postemailicon', $text);
        return $text;
    }
    ...
    public function editIcon()
    {
        ...
        $text = str_replace('icon-edit', 'dd-postediticon', $text);
        return $text;
    }
    ...
    public function printIcon()
    {
        ...
        $text = str_replace('<i class="icon-print', '<i class="dd-postprinticon', $text);
        return $text;
    }
