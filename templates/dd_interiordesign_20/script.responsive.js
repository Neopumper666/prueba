    ...
    responsive: (function ($) {
        ...
        return function () {
            ...
            if (this.isResponsive) {
                if ($("#dd-resp-t").is(":visible") && !this.isTablet) {
                    html.addClass("responsive-tablet").removeClass("responsive-phone");
                    this.isTablet = true;
                    this.isPhone = false;
                    triggerEvent = true;
                } else if ($("#dd-resp-m").is(":visible") && !this.isPhone) {
...
var responsiveCollages = (function ($) {
    ...
    return function (responsiveDesign) {
        $(".dd-collage").each(function () {
            ...
            var sliderOriginalWidth = collage.children(".dd-slider").attr("data-width");
            if (responsiveDesign.isResponsive && collageWidth > parentWidth) {
                collage
                    .add(collage.find(".dd-slider"))
...
var responsiveNav = (function ($) {
    "use strict";
    return function (responsiveDesign) {
        var nav = $("nav.dd-nav"), header, headerMarginTop;
        if (responsiveDesign.isResponsive && nav.parents(".dd-header").length > 0) {
            header = $(".dd-header");
            var otherElement = header.children("*:not(nav.dd-nav):first");
